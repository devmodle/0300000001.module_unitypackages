...
os.system(f"/usr/local/share/dotnet/x64/dotnet mpc -i \"{oProjPath}\" -o \"{oOutputPath}\" -c \"{oConditionalSymbols}\" -ms \"MSG_PACK_ENABLE&&EXTRA_SCRIPT_MODULE_ENABLE&&NEWTON_SOFT_JSON_MODULE_ENABLE\"")
